...
public class BSlicing extends Slicing {

	public BSlicing(CFG cfg, Collection<VariableUsage> variableUsages) {
	...
	public HashSet<CFGNode> getSlicedNode(int line, HashSet<String> variableSet) {
		...
		// R0C.put(criterionNode, getUseNodes(criterionNode.getLineStart(), criterionNode.getLineEnd(), variableUsages));
